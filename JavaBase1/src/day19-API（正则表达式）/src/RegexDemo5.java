...
public class RegexDemo5 {
	public static void main(String[] args) {
		...
		// 身份证号码的简单校验：18位，前17位任意数字，最后一位可以是数字可以是大写或小写的x
		String regex2 = "[1-9]\\d{16}(\\d|X|x)";
		String regex3 = "[1-9]\\d{16}[\\dXx]";    // []表示方括号内的内容出现一个就可以
		String regex5 = "[1-9]\\d{16}(\\d(?i)x)";    // 忽略大小写
		...
		//忽略大小写的书写方式
		String regex4 = "a((?i)b)c";    // 在匹配的时候忽略abc的大小写
		String regex7 = "a(?i)bc";    // 忽略bc的大小写
		String regex8 = "a((?i)b)c";    // 只忽略b的大小写
		...
		// 使用any-rule
		String regex9 = "/^[1-9]\\d{5}(?:18|19|20)\\d{2}(?:0[1-9]|10|11|12)(?:0[1-9]|[1-2]\\d|30|31)\\d{3}[\\dXx]$/";
	}
}
